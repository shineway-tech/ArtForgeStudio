...
|---|---:|---:|---:|---|
| 免费会员 | ¥0 | 首次注册一次性 500 | 无 | 1K |
| 基础会员 | ¥29 | 每周期 3,000 | 95 折 | 2K |
| 高级会员 | ¥69 | 每周期 8,000 | 9 折 | 4K |
| 专业会员 | ¥159 | 每周期 20,000 | 85 折 | 4K |

以上价格和积分是试运营参数。正式上线前尚无真实模型成本数据，因此套餐、折扣、模型积分价格必须由后端配置并支持版本化调整。

### 3.1 免费会员

- 邮箱首次注册并通过风控后，一次性赠送 500 积分。
- 不提供每日签到积分。
- 不提供每月免费积分。
- 可以按原价充值积分。
